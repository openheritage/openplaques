...
class AreasControllerTest < ActionController::TestCase
  ...
  test "getting the areas page for a non-existant country_id" do
  ...
  test "requesting a non-existant area page" do
    get(:show, {:id => "xxxxx", :country_id => countries(:gb).alpha2})
    assert_response(404)
  end

  test "requesting an area page with a mismatched country_id" do
  ...
  test "requesting the page to add an area to an invalid country_id" do
    sign_in users(:frankieroberto)
